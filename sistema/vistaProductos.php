...
if (!empty($_POST)) 
{
    ...
    $query_insert = mysqli_query($conection, "INSERT INTO `PRODUCTO` (`ID_PRODUCTO`, `PRODUCTO`, `UM`, `DESCRIPCION`, `PRC_VENTA`, `PRC_COSTO`, `MARCA`, `CATEGORIA`) 
                                                VALUES (NULL, '$prod ', '$unme', '$desc', '$pVta', '$pCto', '$marc', '$catg');
                                                ");
                                    ...
                                    <table class="table-responsive w-full rounded">
                                        <thead class="bg-grey-dark text-white text-normal">
                                            <tr>
                                                ...
                                                <th class="border w-1/7 px-4 py-2">UM</th>
                                        ...
                                        $consulta_productos = mysqli_query($conection, "SELECT * FROM `PRODUCTO` WHERE ESTATUS = '1'
                                                                                        ORDER BY PRODUCTO LIMIT $desde,$reg_pagina;");
                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="border px-4 py-2"><?php echo $datos_obtenidos['UM']; ?></td>
                                                        ...
                                                        <td class="border px-4 py-2">
                                                            ...
                                                            <a href="../sistema/vistaProducto.php?id=<?php echo $datos_obtenidos['ID_PRODUCTO'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                                <i class="fas fa-eye"></i></a>
