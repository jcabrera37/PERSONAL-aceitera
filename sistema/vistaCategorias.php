...
if (!empty($_POST)) 
{
    ...
    $query_insert = mysqli_query($conection, "INSERT INTO `CATEGORIAS` (`ID_CATEGORIA`, `CATEGORIA`, `ESTATUS`) 
                                            VALUES (NULL, '$categ', '1');");
...
<head>
    ...
    ?>
    <title>Categorías | SerProTec - Soft</title>
</head>
                                    ...
                                    <table class="table-responsive w-full rounded">
                                        <thead class="bg-grey-dark text-white text-normal">
                                            <tr>
                                                ...
                                                <th class="border w-1/2 px-4 py-2">Categoria</th>
                                        ...
                                        $consulta_productos = mysqli_query($conection, "SELECT * FROM `CATEGORIAS` WHERE ESTATUS = '1'
                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        <td class="border px-4 py-2"><?php echo $datos_obtenidos['ID_CATEGORIA']; ?></td>
                                                        <td class="border px-4 py-2"><?php echo $datos_obtenidos['CATEGORIA']; ?></td>
                ...
                <form id='form_id' class="w-full" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/1 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full  border border-grey-200 text-gray-700  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white-500" id="grid-first-name" type="text" name="categoria" placeholder="Categoria">
                        </div>
                    </div>
